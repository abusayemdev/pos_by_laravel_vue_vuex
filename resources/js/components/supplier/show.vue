  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Supplier Profile</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card card-outline">
              <div class="card-body box-profile">
                <div class="text-center">
                  <img class="profile-user-img" :src="'/'+form.photo" id="sup_photo" >
                </div>


                <dl class="row">
                        <dt class="col-sm-3">Supplier Name <span class="float-right">:</span></dt>
                        ...
                        <dt class="col-sm-3" >Shopname<span class="float-right">:</span></dt>
                        <dd class="col-sm-9">{{form.shopname}}</dd>
                    </dl>
